      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li>
                      <a  class="active" href="studentProfile.php"><i class="fa fa-cog"></i> Setting</a>
                  </li>  
              </ul>
              <!-- sidebar menu end-->
          </div>
						...
						<script>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <center><button type="submit" name="register" class="btn btn-theme btn-block" style="width:100px;"><i class="fa fa-lock"></i>  Save</button></center>   				 
                      </form>
					  <?php
					  if(count($_POST)>0) {
						  $matric =$_GET['matric'];
