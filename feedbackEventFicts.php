  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="organizerIndex.php" class="logo"><b>UTeM EVENT</b></a>
            <!--logo end-->
            <div class="top-menu">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li  class="active"><a  href="feedbackEventFicts.php">Event Feedback</a></li>
                      </ul>
                  </li>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
					...
					<section id="unseen">
						...
						if($txtKeyword != "")
						{ 
								  $strSQL = "SELECT * FROM program WHERE program_name LIKE '%".$txtKeyword."%'AND status_program='approved' and end_date < CURDATE() and organizer_id IS NULL ORDER BY end_date DESC";
								  $objQuery = mysqli_query($conn, $strSQL) or die ("Error Query [".$strSQL."]");
								  ...
								  while($objResult = mysqli_fetch_array($objQuery))
								  {
									...
									?>
									  ...
									  <td><a href="viewFeedbackFicts.php?program_code=<?php echo $objResult['program_code']; ?>"><button type="button" class="btn btn-primary">View feedback</button></td>
						...
						{
							$sql = "SELECT * FROM program WHERE end_date < CURDATE() AND status_program='approved' and organizer_id IS NULL  ORDER BY end_date DESC";
							...
							$i = 1;
							 while ($rows = mysqli_fetch_array($result1)) 
							 {
								...
								echo "<tr>";
								  ...
								  echo " <td><a href='viewFeedbackFicts.php?program_code=".$rows['program_code']."'><button type='button' class='btn btn-primary'>View feedback</button></td>";  
							  }
