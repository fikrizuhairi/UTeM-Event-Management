      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
                  	<div class="row mtbox">
                  		<h2 style="margin-top:-40px; padding-left:20px;"><i class="fa fa-angle-right"></"></i>Event Detail</h2>
                      ...
                      <form class="form-horizontal style-form" method="post" >
                       <div class="form-group">
						  ...
						  <!--  <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <?php echo $row['program_session'];?>
                              </div>
                          </div>
						  
						   <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Level Of Event</label>
                              <div class="col-sm-10">
                                  <?php echo $row['level_of_program'];?>
                              </div>
                          </div> -->
						...
						<br />
						  <div class="form-group">
						   ...
						   <div class="form-group">
						    ...
						    <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Propasal</label>
                              <div class="col-sm-10">
                                  <a href="<?php echo $row['upload_proposal'];?> "><i class="fa fa-download" style="font-size:24px"></i><?php echo $row['upload_proposal'];?> 
                              </div>
                          </div>
						  
							 <center><a href="printPdf.php?program_code=<?php echo $row['program_code'];?>? class="btn btn-success" style="margin-top: 5px">print</a></center>	
                      </form>
