  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="advisorIndex.php" class="logo"><b>Better Muslim</b></a>
            <!--logo end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
						  <li class="active"><a href="listToDoAll.php" >All event request</a></li>
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i>List of <button type="button" class="btn btn-warning">Pending</button> event request</h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
								  ...
								  <th><i class="fa fa-user"></i> Organizer / Ficts</th>
							  ...
							  <?php
							  $no = 0;
							  $query = "select * from program where status_program='pending' ORDER BY start_date ASC";
							  ...
							  if(mysqli_num_rows($result)>0)
							  {
								...
								{
									$no++;
									$query1 = "select * from staff where staff_matric_no='".$row["staff_matric_no"]."'";
									$result1 = mysqli_query($conn,$query1);
									$row1 = mysqli_fetch_assoc($result1);
									$staff_name= $row1["staff_name"];
									
									$query2 = "select * from organizer where organizer_id='".$row["organizer_id"]."'";
									$result2 = mysqli_query($conn,$query2);
									$row2 = mysqli_fetch_assoc($result2);
									$organizer_name= $row2["organizer_name"];
							 ?>
                              <tbody>
                              <tr>
                                  <td><?php echo $no; ?></td>
								  ...
								  <?php
								  if($row1["staff_matric_no"]=="")
								  {
									  echo "<td> ".$organizer_name." </td>";
									  echo "<td>Other</td>";
									  echo "<td><a href='updateRequestEventOther.php?program_code= ".$row['program_code']." '><button class='btn btn-success btn-xs' style='background-color:orange; border-color:orange;'><i class='fa fa-eye'></i></button></a></td>";
								?>
								  ...
								  else
								  {
									  ...
									  echo "<td>Staff</td>";
									  echo "<td><a href='updateRequestEvent.php?program_code= ".$row['program_code']." '><button class='btn btn-success btn-xs' style='background-color:orange; border-color:orange;'><i class='fa fa-eye'></i></button></a></td>";
								?>
								<?php
								  }
								  ?>
