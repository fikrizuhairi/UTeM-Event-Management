                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
						  ...
						  <li><a  href="updateList.php">Update event </a></li>
						    <li class="active"><a  href="eventToday.php">Event Today</a></li>
                      </ul>
                  </li>
                  <!-- <li class="sub-menu">
                      <a  href="javascript:;" >
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <?php
								 $sql1 ="select * from program where status_program='approved' and start_date = date(CURRENT_DATE) OR end_date = date(CURRENT_DATE)";
								  ...
								  $query = "select * from program where status_program ='approved' AND staff_matric_no='".$_SESSION["staff"]."' AND start_date = date(CURRENT_DATE) OR end_date = date(CURRENT_DATE) OR start_date >= '".$row2['start_date']."' AND end_date <= '".$row2['end_date']."'";
