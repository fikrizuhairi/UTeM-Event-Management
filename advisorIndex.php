  ...
  <section id="container" >
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
					  ...
					  <!-- <ul class="sub">
                          <li><a  href="paperwork2.php">Paperwork</a></li>
                      </ul>
					   <ul class="sub">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
        ...
        <?php
      $query = "select * from program where status_program='approved' ORDER BY program_code ASC";
          ...
          <div class="col-md-4">
            <form>
              <div style="border: 1px solid #333; background-color: #f1f1f1; border-radius: 5px; padding: 16px;" align="center">
                  ...
                  <a href="infoEventAdvisor.php?program_code=<?php echo $row['program_code'];?>" class="btn btn-success" style="margin-top: 5px">View Program</a>
