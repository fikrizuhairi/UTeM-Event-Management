     ...
     <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <h5 class="centered"><?php echo $row1["organizer_name"]; ?></h5>
				  <h5 class="centered">Organizer</h5>
              	  	
                  <li class="mt">
                      <a  class="active" href="OrganizerIndex.php">
				    ...
				    <h4><i class="fa fa-angle-right"></i>Event Information</h4>
                      <form class="form-horizontal style-form" method="post" action="updateEvent.php">
                       <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="hidden" class="form-control" name="student_id" value="<?php echo $row1['organizer_id'];?>">
                              </div>
                          </div>
                          <div class="form-group">
